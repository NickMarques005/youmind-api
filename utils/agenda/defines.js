...
const agendaDefines = {
    SEND_MEDICATION_ALERT: 'send medication alert',
    SEND_MEDICATION_NOT_TAKEN: 'medication not taken',
    SEND_DAILY_QUESTIONNAIRES_MORNING: 'send daily questionnaires morning',
